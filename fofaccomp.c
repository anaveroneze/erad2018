...
//inputs new column: awk 'BEGIN{FS=OFS=" 0"}{print $0 OFS value}' file
//./runaccomp /home/alsolorzano/Documents/inputstest/Virgo_2novo 0.1 600
//TODO: CONTAGEM DOS GRUPOS
